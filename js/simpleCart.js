        ...
        generateSimpleCart = function(space) {
            ...
            simpleCart.extendCheckout({
                ...
                GoogleCheckout: function(opts) {
                    ...
                    if (!opts.merchantID) {
                        console.log("googleCheckout")
                        return simpleCart.error("No merchant id provided for GoogleCheckout");
                    }

                    // google only accepts USD and GBP
                    if (simpleCart.currency().code !== "GBP" && simpleCart.currency().code !== "GBP") {
            ...
            simpleCart.ready(function() {
                simpleCart.bindOutlets({
                    total: function() {
                        console.log("simpleCart.simpleCart.total: ", simpleCart.toCurrency(simpleCart.total()))
                        $('.totalToPay').html("Pay " + simpleCart.toCurrency(simpleCart.total()));
...
(function() {
    ...
    function o(a) { p.lastIndex = 0; return p.test(a) ? '"' + a.replace(p, function(a) { var c = r[a]; return typeof c === "string" ? c : "\\u" + ("0000" + a.charCodeAt(0).toString(16)).slice(-4) }) + '"' : '"' + a + '"' }
    ...
    function l(a, j) {
        ...
        switch (typeof b) {
            ...
            case "object":
                ...
                if (i && typeof i === "object") { m = i.length; for (c = 0; c < m; c += 1) typeof i[c] === "string" && (d = i[c], (h = l(d, b)) && f.push(o(d) + (e ? ": " : ":") + h)) } else
...
(function() {
    if (!this.localStorage)
        if (this.globalStorage) try { this.localStorage = this.globalStorage } catch (e) {} else {
            ...
            if (a.addBehavior) {
                ...
                var d = this.localStorage = {
                        ...
                        key: function(b) { a.load("localStorage"); return a.XMLDocument.documentElement.attributes[b] }
                    },
                    c = function(a) {
